...
# В с# тип long - это 64-разрядное число со знаком, 
# в диапазоне значений От -9 223 372 036 854 775 808 до 9 223 372 036 854 775 807
# Максимальное знаковое число, которое можно выразить 8 байтами -2^63 и +2^63, 
